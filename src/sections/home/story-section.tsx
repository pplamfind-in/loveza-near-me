...
export function StorySection() {
  return (
    <Box component="section" id="about" sx={{ px: { xs: 1.5, sm: 3 }, py: { xs: 7, md: 6 } }}>
      <Container maxWidth="xl" sx={{ px: { xs: '0 !important', sm: '0 !important' } }}>
        ...
        >
          ...
          >
            <Typography sx={{ color: '#FFD9ED', fontWeight: 900, letterSpacing: 2, fontSize: 12 }}>
              WHY LOVE POTION
            </Typography>
            <Typography
              component="h2"
            ...
            >
              Loveza Love Potion คือเครื่องดื่มโซดาผสมวิตามิน B3, B6 และ B12 ในกระป๋องสลิมขนาด 330
              ml มีให้เลือก 3 รสชาติ สดชื่น ดื่มง่าย และพร้อมส่ง
            </Typography>
          ...
          <Box
            sx={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: { xs: 1.5, sm: 2 } }}
          >
