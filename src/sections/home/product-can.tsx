        ...
        {imageUrl ? (
          <Box
            ...
            sx={{
              ...
              zIndex: 1,
              objectFit: 'contain',
              filter: `drop-shadow(0 30px 28px ${accent}55)`,
            }}
          />
        ) : (
          <Box
          ...
          >
            ...
            <Typography sx={{ mt: 1, fontSize: 12, opacity: 0.85 }}>{thaiName}</Typography>
            <Typography sx={{ mt: 0.6, fontSize: 9, fontWeight: 800, opacity: 0.78 }}>
              {meta}
            </Typography>
          </Box>
        )}
